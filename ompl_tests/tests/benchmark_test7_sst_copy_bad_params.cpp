...
int main(int argc, char **argv)
{
    ...
    for(int i=0; i<files_count; i++){
        ...
        double new_yaw_weight = 5.0/degree2rad(5.0);
        ...
        ss.getSpaceInformation()->setPropagationStepSize(15); //deixar sempre igual ao maxControlDuration para não influenciar em nada
