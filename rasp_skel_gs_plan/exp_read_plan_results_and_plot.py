...
dir = '../exps/{}/solution_paths/'.format(exp_number)
...
for file in onlyfiles:
    ...
    if with_goal_state:
        ...
        # print(array)
    print(dir[:-len("solution_paths/")]+"visualize_plan_results/"+file[:-4]+".png")
    cv2.imwrite(dir[:-len("solution_paths/")]+"visualize_plan_results/"+file[:-4]+".png", array)
