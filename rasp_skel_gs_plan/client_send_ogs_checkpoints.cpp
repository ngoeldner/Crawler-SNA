// g++ client_send_ogs_checkpoints.cpp -o client_send_ogs_checkpoints -I /usr/include/eigen3/ -I /usr/local/include/ompl-1.5 `pkg-config --cflags --libs opencv4` -pthread -lompl
